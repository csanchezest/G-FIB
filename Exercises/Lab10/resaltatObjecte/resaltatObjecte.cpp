...
void ResaltatObjecte::onObjectAdd()
{
	
}

bool ResaltatObjecte::drawScene()
{
	return false; // return true only if implemented
}

bool ResaltatObjecte::drawObject(int)
{
	return false; // return true only if implemented
}

bool ResaltatObjecte::paintGL()
{
	return false; // return true only if implemented
}

void ResaltatObjecte::keyPressEvent(QKeyEvent *)
{
	
}

void ResaltatObjecte::mouseMoveEvent(QMouseEvent *)
{
