...
void Distort::preFrame()
{

}

void Distort::postFrame()
{
    program->release();
}

void Distort::onObjectAdd()
{
	
}

bool Distort::drawScene()
{
	return false; // return true only if implemented
}

bool Distort::drawObject(int)
{
	return false; // return true only if implemented
}
...
bool Distort::paintGL()
{
    ...
    program->setUniformValue("modelViewProjectionMatrix", trans); 
...
void Distort::keyPressEvent(QKeyEvent *)
{
	
}

void Distort::mouseMoveEvent(QMouseEvent *)
{
